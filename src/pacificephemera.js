...
let images = [new Image("../images/pacificephemera/WWII_Korea_029.jpg", "", ""), new Image("../images/pacificephemera/WWII_Korea_030.jpg", "", ""), new Image("../images/pacificephemera/WWII_Korea_031.jpg", "", ""),];
let index = 0;
